...
#     import pdb; pdb.set_trace()
    strand = -1 if "reverse" in bam_file else 1
    ...
    with indexed_bam(bam_file, config) as work_bam:
        ...
        for chrom, start, end in regions:
            ...
            out_handle.write("variableStep chrom=%s span=1\n" % chrom)
...
def convert_to_bigwig(wig_file, chr_sizes, config, bw_file=None):
    ...
    try:
        cl = ["/scratch/jho5ze/bionets/operons/ucsc_tools/wigToBigWig", wig_file, size_file, bw_file]
